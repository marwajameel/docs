...
<Info>The manifest file is used to verify ownership of your app and contains metadata to power search, discovery, and rich embeds in the Base app.</Info>

### Example Manifest
For details on each field, see the[Manifest Field Reference](/mini-apps/features/manifest#field-reference)
...
<Step title="Create Account Association Credentials">
